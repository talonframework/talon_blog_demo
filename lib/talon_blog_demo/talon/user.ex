defmodule TalonBlogDemo.Talon.Accounts.User do
  @moduledoc """
  Use this file to configure how Talon renders your resource.

  TBD
  """
  use Talon.Resource, schema: TalonBlogDemo.Accounts.User, context: TalonBlogDemo.Talon
  ...
  #   TalonBlogDemo.Repo.preload resource, [:some_association]
  # end
