defmodule Talon.Web do
  ...
  def view(opts) do
    quote do
      opts = unquote(opts)
      use Phoenix.View, root: "lib/talon_blog_demo/web/templates/talon/#{opts[:theme]}", namespace: opts[:module]
  ...
  def component_view(opts) do
    quote do
      opts = unquote(opts)
      use Phoenix.View, root: "lib/talon_blog_demo/web/templates/talon/#{opts[:theme]}/components", namespace: opts[:module]
